...
export async function seedSampleData() {
  ...
  const props = [
    ...
    { id:'p003', nickname:'Elm Fork Rd — Mfd',
      ...
      notes:'Needs renovation to reach market rent. Section 8 target.' },
    ...
    { id:'p005', nickname:'Meadow Creek',
      ...
      notes:'Currently vacant — marketing for tenant' },
  ]
  ...
  await save(STORES.MAINTENANCE, { id:'m002', propertyId:'p005', status:'open', priority:'urgent',
    description:'HVAC service before new tenant move-in', dateReported:'2026-03-08', cost:'' })
